...
def explain_prediction(pipeline, input_features, top_k_features=3, training_data=None, include_shap_values=False,
                       output_format="text"):
    ...
    return _make_single_prediction_shap_table(pipeline, input_features, top_k_features, training_data, include_shap_values,
