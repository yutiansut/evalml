...
class AutoMLSearch:
    ...
    def __init__(self,
        ...
        if self.problem_type not in self.objective.problem_type:
    ...
    def _validate_problem_type(self):
        for obj in self.additional_objectives:
            if self.problem_type not in obj.problem_type:
    ...
    def _compute_cv_scores(self, pipeline, X, y):
        ...
        for i, (train, test) in enumerate(self.data_split.split(X, y)):
            ...
            try:
                ...
                if self.optimize_thresholds and ProblemTypes.BINARY in self.objective.problem_type and self.objective.can_optimize_threshold:
                ...
                if ProblemTypes.BINARY in self.objective.problem_type:
